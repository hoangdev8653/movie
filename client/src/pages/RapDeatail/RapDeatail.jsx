...
function RapDeatail() {
  const { heThongRap } = useParams();
  return (
    <div
      style={{ background: "rgb(26, 29, 41)", borderTop: "3px solid #454D6A" }}
      className="w-full "
    >
        ...
        <div className="my-4 flex gap-4">
          ...
          >
            <div className="px-4 my-4 text-white">
              ...
              <p className="text-xl font-bold text-white py-2">
                BHD STAR THE GARDEN
              </p>
              <ul className="py-2">
                <li>Địa chỉ</li>
              ...
              <img
                width="815"
                src="https://www.bhdstar.vn/wp-content/uploads/2023/12/t5_20230903093748782.jpg"
                alt="image"
              />
          ...
          <div className="flex-1 text-white ">
            <div className="px-4 py-4 border-[1px] border-solid border-green-400 rounded">
              <p className="font-semibold text-xl text-center">Địa điểm khác</p>

              <a href="/" className="flex my-4 gap-2">
                <img
                  className="rounded w-[30px] h-[30px]"
                  src="https://www.bhdstar.vn/wp-content/uploads/2023/08/logo.png"
                />
                <span className="text-green-600  text-lg hover:text-green-600">
                  BHĐ Star The Garden
                </span>
              </a>
              <a href="/" className="flex my-4 gap-2">
                <img
                  ...
                  src="https://www.bhdstar.vn/wp-content/uploads/2023/08/logo.png"
                />
                <span className="hover:text-green-600 text-lg">
                  BHĐ Star The Garden
                </span>
              </a>
              <a href="/" className="flex my-4 gap-2">
